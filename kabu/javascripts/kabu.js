 ...
 * Customized for CB Design framework. Backdrops are removed as separate 
 * elements and a opacity transition is used rather than slide down.
 * ========================================================================
 * Copyright 2011-2014 Twitter, Inc.
 * Licensed under MIT (https://github.com/twbs/bootstrap/blob/master/LICENSE)
 * ======================================================================== */
    ...
    Pikaday = function(options)
    {
        ...
        self._onMouseDown = function(e)
        {
            ...
            if (!hasClass(target, 'is-disabled')) {
                ...
                else if (hasClass(target, 'icon-chevron-left')) {
                    self.prevMonth();
                }
                else if (hasClass(target, 'icon-chevron-right')) {
                    self.nextMonth();
                }
            }
...
+function ($) {
  ...
  Tab.prototype.show = function () {
    ...
    var previous = $tabs.find('.active:last')[0]
...
(function($) {
    ...
    var html = function() {
        return {
            wrapper: '<span class="twitter-typeahead inline col-xs-12"></span>',
            dropdown: '<span class="tt-dropdown-menu dropdown-menu col-xs-12"></span>',
            dataset: '<div class="tt-dataset-%CLASS%"></div>',
            suggestions: '<span class="tt-suggestions block"></span>',
            suggestion: '<div class="tt-suggestion pad0y pad2x"></div>'
        };
    }();
    var css = function() {
        "use strict";
    ...
    var Typeahead = function() {
        ...
        function buildDom(input, withHint) {
            ...
            $hint.val("").removeData().addClass("tt-hint pin-topleft").removeAttr("id name placeholder required").prop("readonly", true).attr({
                autocomplete: "off",
                spellcheck: "false",
                tabindex: -1
            });
